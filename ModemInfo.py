...
class ModemInfo(wx.Panel):
    ...
    # Login Information
        ...
        self.jumpServerNameText = wx.TextCtrl(self, -1, size=(130,-1))
        self.jumpUsernameLabel = wx.StaticText(self, -1, 'Username:')
        self.jumpUsernameText = wx.TextCtrl(self, -1, size=(130,-1))
        self.jumpPasswordLabel = wx.StaticText(self, -1, 'Password:')
        self.jumpPasswordText = wx.TextCtrl(self, -1, size=(130,-1), style = wx.TE_PASSWORD)
    ...
    # Modem MAC/IP details
        ...
        self.macIPText = wx.TextCtrl(self, -1, size=(132,-1))
        ...
        macIPStaticBoxSizer.AddSpacer(9)
